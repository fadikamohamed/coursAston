...
export class MeteoService {
  ...
  getByCoord(lon, lat):Observable<any>{
    return this.http.get('https://api.openweathermap.org/data/2.5/forecast?lat='=lat'&lon='+lon'&appid=c06516a3bb199bb320181c589f72433c&units=metric')
    .pipe(
      tap(data => {
        console.log(data)
      }),
